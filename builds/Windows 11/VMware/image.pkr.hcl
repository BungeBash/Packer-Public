...
variable "communicator_type" {
  type        = string
  description = "The communicator type (winrm or ssh)."
}
...
variable "firmware" {
  type        = string
  description = "The firmware type for the virtual machine (bios or efi)."
}

variable "insecure_connection" {
  type        = bool
  description = "Whether to skip SSL certificate verification when connecting to vCenter."
}
...
variable "remove_cdrom" {
  type        = bool
  description = "Whether to remove the CD-ROM device from the virtual machine."
}
...
variable "vmware_cluster" {
  type        = string
  description = "The vSphere cluster where the VM will be created."
}

variable "vmware_datacenter" {
  type        = string
  description = "The vSphere datacenter where the VM will be created."
}

variable "vmware_datastore" {
  type        = string
  description = "The vSphere datastore where the VM will be stored."
}

variable "vmware_folder" {
  type        = string
  description = "The vSphere folder where the VM will be placed."
}

variable "vmware_network" {
  type        = string
  description = "The vSphere network to attach to the VM."
}
...
variable "vmware_tools_path" {
  type        = string
  description = "The path to the VMware tools ISO in the datastore."
}
