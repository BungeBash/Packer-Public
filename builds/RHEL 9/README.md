...
This directory contains Packer configurations for building Red Hat Enterprise Linux 9 server images for both KVM and VMware hypervisors.
...
- **Note**: The checksum in the current configuration appears to be for Ubuntu. Verify and update with correct RHEL 9.7 checksum.
...
### ISO Details
- **ISO Checksum**: `aac774e5aba1c0275d50e0cc4e0e08eca660a116773280596e0bcb894d2da16d`
...
- **ISO Checksum Verification**: Ensure the ISO checksum matches your downloaded ISO
...
- **Guest OS Type**: Uses rhel9_64Guest for both RHEL 9 and RHEL 10 in VMware
